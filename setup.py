...
class _build_scripts(build_scripts):
    def run(self):
        ...
        default_home = os.path.join(prefix, "lib", "qtools")
...
setup(
    ...
    package_dir={"": "python"},
    data_files=[
        *find_data_files("python", "lib/qtools"),
        *find_data_files("test-certs", "lib/qtools"),
        ("lib/qtools", ["VERSION.txt"]),
    ],
    scripts=[
        "bin/qbroker.in",
        "bin/qconnect.in",
